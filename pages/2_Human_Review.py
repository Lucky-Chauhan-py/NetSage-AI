...
st.markdown(
    ...
    <div style="margin-bottom:20px;">
        <h1 style="color:#F9FAFB; font-weight:800; font-size:2.2rem; margin-bottom:4px;">👤 Human-in-the-Loop Review Board</h1>
        <p style="color:#9CA3AF; margin:0; font-size:0.95rem;">
            Responsible AI Governance: Zero autonomous AI diagnosis is deployed without verified engineer oversight.
        </p>
    </div>
    """,
    unsafe_allow_html=True,
